					...
					if descendant:IsA("Part") or descendant:IsA("Model") or descendant:IsA("MeshPart") then
						...
						pcall(function()
							if blockaderemover.Value == true then
								if descendant.Name == "Blockage" or descendant.Name == "WoodenBarricade" or descendant.Name == "InvisibleWall" or descendant.Name == "Wax_Door" or descendant.Name == "MovingDoor" or descendant.Name == "Bookcase" or descendant.Name == "Modular_Bookshelf" or descendant.Name == "Table" then
									descendant:Destroy()
